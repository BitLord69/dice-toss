<template>
  <img src="./assets/dice-target.png" alt="dice target" class='die-face'>
  ...
  <div class='rolled-text'>You have selected {{ words[numDice - 1] }} {{ numDice === 1 ? 'die' : 'dice' }}.</div>
  
  <div class='dice-container'>
    <Die v-for='n in numDice' :key='n' :dieNum='n' class='die' />
  </div>
...
button {
  ...
  transition: ease-in-out, size .2s ease-in-out;
